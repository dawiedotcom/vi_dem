...
#include "pair_gran_hooke_bond.h"
#include <cmath>
#include "atom.h"
#include "force.h"
#include "fix.h"
...
PairGranHookeBond::PairGranHookeBond(LAMMPS *lmp) : PairGranHooke(lmp)
{
...
void PairGranHookeBond::compute(int eflag, int vflag)
{
...
double PairGranHookeBond::single(int i, int j, int /*itype*/, int /*jtype*/, double rsq,
